...
namespace UnityEngine.XR.Content.Interaction
{
    ...
    public class ObjectReset : MonoBehaviour
    {
        ...
        void ResetTransform(NetworkPhysicsInteractable networkBaseInteractable)
        {
            ...
            if (networkBaseInteractable.TryGetComponent(out NetworkTransform networkTransform))
            {
                networkTransform.Teleport(m_ResetTransform.position, m_ResetTransform.rotation, networkBaseInteractable.transform.localScale);
            }
